...
***B.Sc.*** **Electrical Engineering and Computing**\
Study programme: Computer Engineering and Informatics
...
💻 **HTEC Group**, Belgrade, Serbia (Oct 2020 — Jan 2021)\
**Firmware Intern**\
...
📃 Pavle Subotić, **Uroš Bojanić**, and Milan Stojić. 2022. Statically Detecting Data Leakages in Data Science Code. In *Proceedings of the 11th ACM SIGPLAN International Workshop on the State Of the Art in Program Analysis (SOAP ’22), June 14, 2022, San Diego, CA, USA*. ACM, New York, NY, USA, 7 pages. <a href="https://doi.org/10.1145/3520313.3534657">https://doi.org/10.1145/3520313.3534657</a>
...
⌨️ **Assembler, linker, loader** [*Redacted*]
> Software development toolchain implementation in C++: assembler, linker, and loader with emulator.
...
🖥️ **8-bit computer** [(URL)](https://github.com/uros-bojanic/8-bit-computer)
...
> Writer-independent approach for offline hand signature verification using deep learning with TensorFlow and VGG16.

🦠 **Epidemic prediction model** [(URL)](https://github.com/uros-bojanic/epidemic-modelling)
> SIR/SIRS/SIRQ/ISIR/SEIR compartmental models for numerical epidemic modelling in MATLAB.
...
> Map-aware robot localization using Sequential Monte Carlo methods, implemented using Java and Processing IDE.
